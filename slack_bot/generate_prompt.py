...
def generate_prompt(mode="image-edit", injection=""):
    ...
    Add elements to ensure that the design is suitable for Christmas.
    ...
    Keep the text simple and precise. If text is too small to be regenerated accurately, omit it.
